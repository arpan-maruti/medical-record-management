...
export class DataService {
    ...
    cases: [
      {
        ...
        case_status: 'status1',
        files: ['file1', 'file2'],
        parameters: ['param1_inst1', 'param1_inst2'],
      },
      {
        _id: 'case2',
        parent_id: 'null',
  ...
  getParametersByInstructionId(instructionId: string): Array<any> {
    return this.mockData.parameters.filter(
      (param) => param.instruction_id === instructionId
    );
  }
  getInstructionTypesByLoiId(loiId: string): Array<any> {
    return this.mockData.instruction_types.filter(
